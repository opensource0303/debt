                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    >
                        <div className="relative">
                            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl blur-lg opacity-75 animate-pulse"></div>
                            <motion.img
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <p className="text-gray-400 leading-relaxed">
                                澳门作为自由港，资金成本显著低于内地，且拥有大量沉淀的离岸人民币，为平台提供资金支持。
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-400 leading-relaxed">
                                采用零知识证明和多方安全计算技术，在保护商业秘密的同时实现数据有效利用，解决跨境风控痛点。
                            </p>
                        </motion.div>
                    </div>
                </motion.div>
