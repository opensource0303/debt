        ...
        <section
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                            ...
                            >
                                ...
                                <div className="relative z-20 w-full md:w-1/2 text-center md:text-left">
                                    ...
                                    >
                                        ...
                                        <p
                                            className={`text-gray-200 mb-6 max-w-md md:max-w-lg mx-auto md:mx-0 leading-relaxed ${
                                        ...
                                        <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center md:justify-start">
                                            <Link 
                                                to={index === 0 ? "/solutions-cases" : index === 1 ? "/macau-advantages" : "/solution-cases"}
                                                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full text-lg font-medium transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                                            >
                                                {slide.ctaText}
                                            </Link>
                                            <Link 
                                                to="/contact"
                                                className="bg-transparent border-2 border-white text-white hover:bg-white/10 px-6 py-3 rounded-full text-lg font-medium transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50"
                                            >
                                                联系我们
                                            </Link>
                                        </div>
                    ...
                    {/* 轮播指示器 - 移动端优化样式 */}
                    <div
                        className={`absolute bottom-6 left-1/2 transform -translate-x-1/2 z-30 flex space-x-2 md:space-x-3 ${
                            isMobile ? "space-x-3" : ""
                        }`}
                    >
                        {slides.map((_, index) => (
                    ...
                    {/* 左右导航按钮 - 移动端优化 */}
                    <button
                        className={`absolute left-3 top-1/2 transform -translate-y-1/2 z-30 w-10 h-10 md:w-12 md:h-12 bg-black/50 backdrop-blur-md hover:bg-black/70 rounded-full flex items-center justify-center text-white transition-all shadow-lg ${
                            isMobile ? "w-12 h-12" : ""
                        }`}
                        onClick={prevSlide}
                    ...
                    >
                        <i className={`fas fa-chevron-left ${isMobile ? "text-xl" : "text-lg md:text-xl"}`}></i>
                    </button>
                    
                    <button
                        className={`absolute right-3 top-1/2 transform -translate-y-1/2 z-30 w-10 h-10 md:w-12 md:h-12 bg-black/50 backdrop-blur-md hover:bg-black/70 rounded-full flex items-center justify-center text-white transition-all shadow-lg ${
                            isMobile ? "w-12 h-12" : ""
                        }`}
                        onClick={nextSlide}
                        ...
                        style={{ minWidth: "48px", minHeight: "48px" }}
                    >
                        <i className={`fas fa-chevron-right ${isMobile ? "text-xl" : "text-lg md:text-xl"}`}></i>
                    </button>
                </div>
