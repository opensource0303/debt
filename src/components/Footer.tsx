                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div>
                        <div className="flex items-center mb-6">
                            <img src="https://s.coze.cn/t/x5GlETxxCsM/" alt="可信达 Cred" className="h-8 mr-3" />
                            <div className="text-xl font-bold">可信达</div>
                        </div>
                        <p className="text-gray-400 mb-6">赋能核心企业，促进债务凭证在供应链范围内自由流动</p>
