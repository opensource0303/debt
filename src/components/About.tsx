            ...
            <div className="container mx-auto px-4 relative z-10">
                <motion.div
                    ...
                    <motion.div
                        ...
                        <h3
                            className={`font-bold text-white mb-6 ${isMobile ? "text-xl md:text-2xl text-center" : "text-2xl md:text-3xl"}`}>核心价值</h3>
                        <p
                            className={`text-gray-300 mb-8 leading-relaxed ${isMobile ? "text-base md:text-lg" : "text-xl"}`}>"可信达"平台通过创新技术和商业模式，为解决三角债问题提供了全面、高效、安全的解决方案，实现债务有效清偿和资产盘活。
                                                                    </p>
