            ...
            <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">珠海市横琴华发商都</p>
                    </div>
                  </div>
                  ...
                  <div className="flex space-x-4">
                    {['weixin', 'weibo', 'linkedin', 'twitter'].map((social, index) => (
                      <a 
                        key={index}
                        href="#" 
                        className="w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                      >
                ...
                <div className="mt-12">
                  ...
                  <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                    <p className="text-gray-600 dark:text-gray-300 flex items-center">
                      ...
                      对于平台紧急问题，请拨打 +853-2888-8888 或发送邮件至 bruce@cred.top
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
                  ...
                  <div className="mb-6">
                    <label htmlFor="subject" className="block text-gray-700 dark:text-gray-300 mb-2 font-medium">咨询主题</label>
                    <select
                      id="subject"
                      name="subject"
                  ...
                  <div className="mb-8">
                    <label htmlFor="message" className="block text-gray-700 dark:text-gray-300 mb-2 font-medium">咨询内容</label>
                    <textarea
                      id="message"
                      name="message"
                      ...
                      rows={6}
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                      placeholder="请详细描述您关于平台的问题或合作意向"
                    ></textarea>
                  </div>
                  
                  <button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-4 rounded-lg font-medium transition-all transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                  >
                    提交咨询
                  </button>
                </form>
        ...
        <section className="py-16 bg-white dark:bg-gray-800">
          <div className="container mx-auto px-4">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">常见问题</h2>
            ...
            >
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                  <h3 className="text-xl font-semibold mb-4">什么是多角债？</h3>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                  <h3 className="text-xl font-semibold mb-4">澳门平台的双轨制引擎是什么？</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                  <h3 className="text-xl font-semibold mb-4">如何解决跨境数据合规问题？</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                  <h3 className="text-xl font-semibold mb-4">平台的收费标准是怎样的？</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                  <h3 className="text-xl font-semibold mb-4">如何参与澳门多角债解决平台？</h3>
                  <p className="text-gray-600 dark:text-gray-300">
